...
class AppColor {
  ...
  static const Color grey2 = Color.fromRGBO(120, 120, 120, 1);
  static const Color black = Color(0xff000000);
  // static const Color primaryColor = Color(0xff5DB1DF);
  static const Color backgroundcolor = Color(0xffF8F9FD);
  static const Color whiteoundcolor = Color.fromARGB(255, 255, 255, 255);
  ...
  static const Color fourthColor = Color.fromARGB(255, 2, 47, 171);
}
